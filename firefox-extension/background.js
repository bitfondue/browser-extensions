browser.browserAction.onClicked.addListener(function(tab){
	...
	let gatheringActions = [
		...
		browser.tabs.sendMessage(tab.id, {method: "getHTML"}).then(onHtmlCaptured, onError),
		browser.tabs.query({currentWindow: true, active: true}).then(onTabInformationCaptured, onError)
	]
